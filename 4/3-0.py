...
#   left = sorted_list[0]
#   right = sorted_list[length_of_list-1]
  
#   def Count(mid):
#     count = 0
#     sum_record = 0
#     for i in range(0, length_of_list):
#       sum_record = sum_record+l[i]
#       if(sum_record)

#   res = 0
#   while left <= right:
#     mid = (left+right)//2
#     if Count(mid) >= count_of_record:
#       res = mid
#       mid=left+1
#     elif Count(mid) < count_of_record:
#       mid=right-1
#   print(res)
...
#   while left<=right:
#     mid=(left+right)//2
#     if mid >=list_max_value and Count(mid) <= m:
#       res=mid
#       right=mid-1
#     else:
#       left=mid+1
